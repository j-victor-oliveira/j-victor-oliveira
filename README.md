...
| Layer | Tech |
|---|---|
| **Languages** | Go · C++ · Python · C |
| **Databases** | PostgreSQL · Redis · MySQL |
| **Infrastructure** | Docker · Kubernetes · AWS · GCP |
| **AI / Vision** | OpenCV · CUDA · ROS · SLAM |
| **Hardware** | FPGA · VHDL · Verilog · Assembly |
...
Optional: Python worker for analytics / anomaly detection
```
...
- 🤖 **Competitive robotics** — Perception, localization (SLAM), and embedded control for competition robots
- 💬 **Conversational AI** — Chatbot systems project at university
- 🔩 **Hardware background** — FPGA design, computer architecture, low-level systems
...
- [ ] Ship `go-vault` v1 with full test coverage and idempotency layer
- [ ] Deploy on a real VPS (not just localhost)
- [ ] Contribute to an open-source Go project
- [ ] Land a backend role where the scale is real
